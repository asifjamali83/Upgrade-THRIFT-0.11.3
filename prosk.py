...
"""%(Bot_startTime))
#==============================================================
cl = LINE("EFVqmPUzovxHj4VRqHc8.V9fPQ4Ni715zhNxzTDLx/a.O9nhqLl/YEfplvov4c/ZUxBrqBQJSShliSob4d3xphs=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Selfbot Login ]\033[0m"""%(Bot_startTime))

k1 = LINE("EFe97tso2gYuLhKt4dEd.CNZNgt3iUc3fYRhn7Cibxq.mgzLF4qnypPGX8zaqyYK63eHbHi8VeZ/o0pVwtnzVE8=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist1 Login ]\033[0m"""%(Bot_startTime))

k2 = LINE("EFFxETCpqI39SfG3mu64./Coef04cSd1Ymaih+V2ADa.krNSTR+oQb2ayVp5kyycF+TLGl8B7B1nfqGAwxvPRV4=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist2 Login ]\033[0m"""%(Bot_startTime))

k3 = LINE("EFPmUT3BgSqxnyPjVIA0.nvD/uRjfRoBETK4ZOWhZSa.ArzN7VFTWrbBLNa2i3op4uBx+2ZpNR8/WCzBbXZ+qMc=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist3 Login ]\033[0m"""%(Bot_startTime))

k4 = LINE("EFWQpnlbmiiopY7t0s0a.uA70OmZ6xGXhLjifkBHlgG.ms3qCImhvLVq3J0XiV8+uu9iIitLZj/7ywnGBF8UkkI=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist4 Login ]\033[0m"""%(Bot_startTime))

k5 = LINE("EFQFxG1kScdYaptmNRn7.4ciXpOp+ngV1ye23dcM5vW.z555GdYPtq4J2FxiyeotZVnBuZVYPoylerZmNusKgmE=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist5 Login ]\033[0m"""%(Bot_startTime))

k6 = LINE("EFYPjxZafIjmUE9NQ0b7.t/IdFcgcW7pVEtQdsL6WzW.cqNKbeaLxn5ppRwWrrijh3ew5uy9gB5ZcHbq5yZld7k=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist6 Login ]\033[0m"""%(Bot_startTime))

k7 = LINE("EF7RrhB4RBMWpKc1TMk9.sq7xakrN1v28/yW8CSq42q.+wQCwVzvZIc/9IesZJOQEFaSVD0DQn4O3LZeSRwAj0Y=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist7 Login ]\033[0m"""%(Bot_startTime))

k8 = LINE("EFi0zkIY8mDFNCGVsved.JZJ/1Jhb9oyNKqIA+uiyFq.D5hOUkqfqw4F0me64+ssKiVRNzer/EVt3VKskjd4a7w=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist8 Login ]\033[0m"""%(Bot_startTime))

k9 = LINE("EFW1FmovNsAqc7cy2qQ2.XhCwJBakhq3WIw4uZqu08G.bh3OQYTBkNXODgQx75/RNlEdjXXzqhIhHK0HhGRUl0U=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist9 Login ]\033[0m"""%(Bot_startTime))

k10 = LINE("EFR5r2GZDRWcBPhIQeJ1.f04Z5tIwN8oo0wvkaqNsqq.z6bXJOjXT/i6GqAGscEjM/GOv4Bnd/EYunwNIt2SKGE=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist10 Login ]\033[0m"""%(Bot_startTime))

g1 = LINE("EFePb4BhHikGv84shb69.4vNGKfbDYS0efY/RcqAJMq.SCe1krxz030nu0QK/b3UKnXzn334zeW05daFVdLQcT0=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Kicker1 Login ]\033[0m"""%(Bot_startTime))

g2 = LINE("EFdSeLcRjTD28EE2VDzb.bAXEGo6vXQI0VRhomlb3MW.RB++uBeJD0ZTgxQPryvsg2DX/DUu9JauauUxdir4YOU=")
...
oepoll = OEPoll(cl)
call = cl
creator = ["ubfd169ab89c8ef5e591e75d9b5d957f8"]
...
def help():
    ...
    key = key.title()
    helpMessage = "╭━━━━━━━━━━━━━━━\n"
    helpMessage += "│┃ " + "╭──⍟ღThe Rascals۝⍟─\n"
    helpMessage += "│┃" + " ├───༼ᴍᴇɴᴜ ʙᴏᴛ sɪʟᴇɴᴛ༽────────────────\n"
    helpMessage += "│┃" + " ├──────────────\n"
    helpMessage += "│ღ %i. " % num + key + "ᴍᴇ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "sᴘ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴋᴇᴘᴏ @\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴍʏʙᴏᴛ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ɴᴀᴍᴇ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴍᴀsᴜᴋ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴘᴜʟᴀɴɢ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴜᴘʙᴏᴛ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ɢᴇᴛᴍɪᴅ @\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴀʙᴏᴜᴛ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴛɪᴍᴇ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴄʀᴇᴀᴛᴏʀ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ɢʟɪsᴛ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴏᴘᴇɴ\n"
    num = (num+1)    
    helpMessage += "│ღ %i. " % num + key + "ᴏᴜʀʟ\n"
    num = (num+1)
    helpMessage += "│ღ %i ." % num + key + "ᴄᴜʀʟ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ɢʀᴜᴘɪɴғᴏ ɴᴏ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "sᴛᴀғғʟɪsᴛ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ʙᴏᴛʟɪsᴛ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ʜᴀᴘᴜsᴄʜᴀᴛ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "sɪᴅᴇʀ ᴏɴ[ᴏғғ]\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴛᴇs\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴜᴘɢʀᴜᴘ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ʙᴄᴀsᴛ:「ᴛᴇxᴛ」\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "sᴇᴛɴᴀᴍᴇ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ɴᴀᴍᴇ: ɴᴀᴍᴀ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ɴᴀᴍᴇ1/10: ɴᴀᴍᴀ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ʀᴇsᴇᴛɴᴀᴍᴇ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "s:sɪᴅᴇʀ: ᴛᴇxᴛ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "sᴘᴇsᴀɴ: ᴛᴇxᴛ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "sᴡᴇʟᴄᴏᴍᴇ: ᴛᴇxᴛ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "sʀᴇsᴘᴏɴ: ᴛᴇxᴛ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴜᴘʙᴏᴛ 「ubah foto」\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "1/10ᴜᴘ 「ubah foto」\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴄsɪᴅᴇʀ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴄᴘᴇsᴀɴ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴄʀᴇsᴘᴏɴ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴄᴡᴇʟᴄᴏᴍᴇ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "sᴛɪᴄᴋᴇʀ「ᴏɴ/ᴏғғ」\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ʀᴇsᴘᴏɴ「ᴏɴ/ᴏғғ」\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴜɴsᴇɴᴅ「ᴏɴ/ᴏғғ」\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴀᴜᴛᴏʙʟᴏᴄᴋ「ᴏɴ/ᴏғғ」\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴡᴇʟᴄᴏᴍᴇ「ᴏɴ/ᴏғғ」\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ʟᴀɢᴜ ᴊᴜᴅᴜʟ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "sᴍᴜʟᴇ:「ʟɪɴᴋ」 \n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "!ɢᴏᴏɢʟᴇ ᴄᴀʀɪ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ʏᴛᴍᴘ4: ᴄᴀʀɪ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴄʜᴀɴɢᴇᴅᴜᴀʟ \n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴄʜᴀɴɢᴇᴅᴜᴀʟʟɪɴᴋ•\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ɪᴍɢ ғᴏᴏᴅ: ᴄᴀʀɪ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴘʀᴏғɪʟᴇsᴍᴜʟᴇ: ɪᴅ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + " ᴘʀᴏғɪʟᴇɪɢ: ɪᴅ\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴍᴇᴍᴇ@1@2@3\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴛᴀғsɪʀǫᴜʀᴀɴ ɴᴏ|ɴᴏ\n"
    num = (num+1)    
    helpMessage += "│ღ %i. " % num + key + "ᴀᴅᴅɪᴍɢ •ᴋᴀᴛᴀ•\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴅᴇʟʟɪᴍɢ •ᴋᴀᴛᴀ•\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ʟɪsᴛɪᴍɢ •ᴋᴀᴛᴀ•\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴀᴅᴅᴠɪᴅᴇᴏ •ᴋᴀᴛᴀ•\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴅᴇʟʟᴠɪᴅᴇᴏ •ᴋᴀᴛᴀ•\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ʟɪsᴛᴠɪᴅᴇᴏ •ᴋᴀᴛᴀ•\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴀᴅᴅsᴛɪᴄᴋᴇʀ •ᴋᴀᴛᴀ•\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴅᴇʟʟsᴛɪᴄᴋᴇʀ •ᴋᴀᴛᴀ•\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ʟɪsᴛsᴛɪᴄᴋᴇʀ •ᴋᴀᴛᴀ•\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴀᴅᴅᴀᴜᴅɪᴏ •ᴋᴀᴛᴀ•\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ᴅᴇʟʟᴀᴜᴅɪᴏ •ᴋᴀᴛᴀ•\n"
    num = (num+1)
    helpMessage += "│ღ %i. " % num + key + "ʟɪsᴛᴀᴜᴅɪᴏ •ᴋᴀᴛᴀ•\n"
    num = (num+1)    
    helpMessage += "│┃ " + "├──────────────\n"
    helpMessage += "│┃ " + "╰──⍟ ღThe Rascals۝ ⍟─────────\n"
    helpMessage += "╰━━━━━━━━━━━━━━━━"
    helpMessage += " Creator: 􀰂􀰂✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η࿐❥ \n"
    return helpMessage
...
def helpbot():
    ...
    key = key.title()
    helpMessage2 = "╭━━━━━━━━━━━━━━━━\n"
    helpMessage2 += "│┃ " + "╭───⍟ღThe Rascals۝⍟─\n"
    helpMessage2 += "│┃" + " ├───༼ᴄᴏᴍᴍᴀɴᴅ ᴋɪᴄᴋᴇʀ༽────────────\n"
    helpMessage2 += "│┃" + " ├──────────────\n"
    helpMessage2 += "│ღ %i. " % num + key + "ᴋɪᴄᴋᴇʀ @\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴠᴄ @ \n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴍᴀɪɴᴋᴀɴ @\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ɪɴᴠɪᴛᴇ:on \n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ʙʟ \n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ʙᴀɴʟɪsᴛ \n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ғʀᴇsʜ/ʀᴇғʀᴇsʜ \n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ɢᴀs \n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴋɪʟʟʙᴀɴ \n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "sᴘᴀᴍɪɴᴠɪᴛᴇ ᴏɴ/ᴏғғ \n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴀᴅᴅʙᴏᴛ \n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ʙᴀɴᴀʟʟ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴄʟᴇᴀʀʙᴀɴ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴀᴅᴍɪɴ ᴏɴ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴀᴅᴍɪɴ @\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴀᴅᴍɪɴᴅᴇʟʟ @\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴀᴅᴍɪɴ ᴏғғ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + " ᴏᴡɴᴇʀ ᴏɴ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "sᴛᴀғғ ᴏɴ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "sᴛᴀғғᴅᴇʟʟ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "sᴛᴀғғ @\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "sᴛᴀғғᴅᴇʟʟ @\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ʙᴏᴛ ᴏɴ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ʙᴏᴛᴅᴇʟʟ \n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ʙᴏᴛ @\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ʙᴏᴛᴅᴇʟʟ @\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ʙᴀɴ @\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ʙᴀɴᴅᴇʟʟ @\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ʙᴀɴ ᴏɴ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ʙᴀɴᴅᴇʟʟ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴛᴀʟᴋʙᴀɴ ᴏɴ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "s bl\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "s dbn\n"
    num = (num+1)
    helpMessage2 += "│ღ %i ." % num + key + "ᴛᴀʟᴋʙᴀɴᴅᴇʟʟ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴛᴀᴋʙᴀɴ @\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + " ᴛᴀʟᴋʙᴀɴᴅᴇʟʟ @\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴛᴀʟᴋʙᴀɴʟɪsᴛ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴀʟʟᴘʀᴏ ᴏɴ/ᴏғғ\n"
    num = (num+1)    
    helpMessage2 += "│ღ %i. " % num + key + "ᴘʀᴏᴛᴇᴄᴛǫʀ ᴏɴ/ᴏғғ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴘʀᴏᴛᴇᴄᴛᴜʀʟ ᴏɴ/ᴏғғ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴘʀᴏᴛᴇᴄᴛᴋɪᴄᴋ ᴏɴ/ᴏғғ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴘʀᴏᴛᴇᴄᴛᴊᴏɪɴ ᴏɴ/ᴏғғ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴘʀᴏᴛᴇᴄᴛɪɴᴠɪᴛᴇ ᴏɴ/ᴏғғ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴘʀᴏᴛᴇᴄᴛᴄᴀɴᴄᴇʟ ᴏɴ/ᴏғғ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴊs ᴏɴ/ᴏғғ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ʙʏᴇ1/10\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ʟᴇᴀᴠᴇɢʀᴜᴘ「ɴᴏ」\n"
    num = (num+1)    
    helpMessage2 += "│ღ %i. " % num + key + "ᴋɪᴄᴋᴇʀ「ɪɴ」\n"
    num = (num+1)  
    helpMessage2 += "│ღ %i. " % num + key + "ᴋɪᴄᴋᴇʀ「ʟᴠ」\n"
    num = (num+1)    
    helpMessage2 += "│ღ %i. " % num + key + "ɪɴғᴏɢʀᴜᴘ「ɴᴏ」\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ɪɴғᴏᴍᴇᴍʙᴇʀ「ɴᴏ」\n"
    num = (num+1)     
    helpMessage2 += "│ღ %i. " % num + key + "sɪʟᴇɴᴛᴋɪʟʟᴇʀ [ᴋɪᴄᴋᴀʟʟ]\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ʙᴜʙᴀʀ [ᴋɪᴄᴋᴀʟʟ]\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "sɪʟᴇɴᴛ1/2 \n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴀᴜᴛᴏᴊᴏɪɴ ᴏɴ/ᴏғғ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴀᴜᴛᴏᴀᴅᴅ ᴏɴ/ᴏғғ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴀᴜᴛᴏʟᴇᴀᴠᴇ ᴏɴ/ᴏғғ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴀᴜᴛᴏʙʟᴏᴋ ᴏɴ/ᴏғғ\n"
    num = (num+1)
    helpMessage2 += "│ღ %i. " % num + key + "ᴊᴏɪɴᴛɪᴄᴋᴇᴛ ᴏɴ/ᴏғғ\n"
    num = (num+1)
    helpMessage2 += "│┃ " + "├──────────────\n"
    helpMessage2 += "│┃ " + "╰──⍟ ღThe Rascals۝ ⍟────────\n"
    helpMessage2 += "╰━━━━━━━━━━━━━━━━"
    helpMessage2 += " 􀰂􀰂✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η࿐❥\n"
    return helpMessage2
                ...
                if g2MID in op.param3:
                    if op.param2 not in Bots and op.param2 not in Saint and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        try:
                            ...
                            try:
                                k1.inviteIntoGroup(op.param1,[g2MID])
                                k1.kickoutFromGroup(op.param1,[op.param2])
                     ...
                     if msg.from_ in admin:
                         ...
                         for s in groups.members:
                             if _name in s.displayName:
                                 ...
                                 ki.sendText(msg.to,"These Are not your commands !, \n➡Unban: " + invite)
                                 break                             
                             else:
                                 targets.append(invite)
                         if targets == []:
               ...
               if msg.contentType == 16:
                  if msg.toType in (2,1,0):
                     try:
                         ...
                         cl.createComment(mat[0], mat[1], "ᴀᴜᴛᴏʟɪᴋᴇ ʙʏ: 􀰂􀰂✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η࿐❥")
                         cl.sendReplyMessage(msg.id, to, "➥􀰂􀰂✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η࿐❥")
                     except Exception as e:
                 ...
                 if wait["detectMention"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           cl.sendMessage(msg.to, None, contentMetadata={""}, contentType=7)
                           cl.sendMessage(msg.to, wait["Respontag"])
                           cl.sendImageWithURL(msg.to,image)
                           rnd = ["thє tαggíng hσpєfullч gσєs tσ hєαvєn, αmєєn"]
                           p = random.choice(rnd)
                           lang = 'id'
               ...
               if msg.contentType == 1:
                  if msg._from in mid:
                     if settings["Addimage"]["status"] == True:
                         ...
                         cl.sendMessage(msg.to, "".format(str(settings["Addimage"]["name"])))
...
#SC ADD ADMIN
                 ...
                 if wait["delladmin"] == True:
                    if msg.contentMetadata["mid"] in admin:
                        ...
                        wait["delladmin"] = True
                        cl.sendMessage(msg.to,"Contact  is not admin")
#SC ADD BLACKLIST
                 if msg._from in owner:
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                   if settings["changePicture"] == True:
                     ...
                     k1.sendMessage(msg.to, "ᴀsɪsᴛ 1 succєssfullч ᴜᴘᴅᴀᴛᴇ ғᴏᴛᴏ")
                     k2.updateProfilePicture(path2)
                     k2.sendMessage(msg.to, "ᴀsɪsᴛ 2 succєssfullч ᴜᴘᴅᴀᴛᴇ ғʜᴏᴛᴏ")
                     k3.updateProfilePicture(path3)
                     k3.sendMessage(msg.to, "ᴀsɪsᴛ 3 succєssfullч ᴜᴘᴅᴀᴛᴇ ғᴏᴛᴏ")
                     k4.updateProfilePicture(path4)
                     k4.sendMessage(msg.to, "ᴀsɪsᴛ 4 succєssfullч ᴜᴘᴅᴀᴛᴇ ғᴏᴛᴏ")
                     k5.updateProfilePicture(path5)
                     k5.sendMessage(msg.to, "ᴀsɪsᴛ 5 succєssfullч ᴜᴘᴅᴀᴛᴇ ғᴏᴛᴏ")
                     k6.updateProfilePicture(path6)
                     k6.sendMessage(msg.to, "ᴀsɪsᴛ 6 succєssfullч ᴜᴘᴅᴀᴛᴇ ғᴏᴛᴏ")
                     k7.updateProfilePicture(path7)
                     k7.sendMessage(msg.to, "ᴀsɪsᴛ 7 succєssfullч ᴜᴘᴅᴀᴛᴇ ғᴏᴛᴏ")
                     k8.updateProfilePicture(path8)
                     k8.sendMessage(msg.to, "ᴀsɪsᴛ 8 succєssfullч ᴜᴘᴅᴀᴛᴇ ғᴏᴛᴏ")
                     k9.updateProfilePicture(path9)
                     k9.sendMessage(msg.to, "ᴀsɪsᴛ 9 succєssfullч ᴜᴘᴅᴀᴛᴇ ғᴏᴛᴏ")
                     k10.updateProfilePicture(path10)
                     k10.sendMessage(msg.to, "ᴀsɪsᴛ 10 succєssfullч ᴜᴘᴅᴀᴛᴇ ғᴏᴛᴏ")
                     g1.updateProfilePicture(path11)
                     g1.sendMessage(msg.to, "ʜᴀɴᴛᴜ 1 succєssfullч ᴜᴘᴅᴀᴛᴇ ғᴏᴛᴏ")
                     g2.updateProfilePicture(path12)
                     g2.sendMessage(msg.to, "ʜᴀɴᴛᴜ 2 succєssfullч ᴜᴘᴅᴀᴛᴇ ғᴏᴛᴏ")
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "on":
                            if msg._from in owner or msg._from in admin or msg._from in staff:
                                wait["selfbot"] = True
                                cl.sendMessage(msg.to, "𝔗𝔥𝔢 𝔟𝔬𝔱 𝔥𝔞𝔰 𝔟𝔢𝔢𝔫 𝔞𝔠𝔱𝔦𝔳𝔞𝔱𝔢𝔡")
                                
                        elif cmd == "off":
                            if msg._from in owner or msg._from in admin:
                                wait["selfbot"] = False
                                cl.sendMessage(msg.to, "вσts αrє slєєpíng nσw")
                          ...
                          if wait["selfbot"] == True:
                    	    ...
                    	    if msg._from in owner or msg._from in admin or msg._from in staff: 
                              ...
                              cl.sendMessage(msg.to, None,contentMetadata={'mid': sender}, contentType=13)
                               ...
                               cl.sendMessage(msg.to, "ʙᴏᴛs ᴀʀᴇ ʀᴇᴀᴅʏ ᴛᴏ sᴛᴀʏ ᴘʀᴏᴛᴇᴄᴛ ᴍᴀxɪᴍᴀʟʟʏ")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(to, "Maximum speed of bot🏁")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:                          	
                              ...
                              cl.sendMessage(msg.to,"Succes Clear Blacklist".format(str(len(wait["blacklist"]))))                             
                              k1.sendMessage(msg.to,"Succes Clear Blacklist".format(str(len(wait["blacklist"])))) 
                              k2.sendMessage(msg.to,"Succes Clear Blacklist".format(str(len(wait["blacklist"])))) 
                              k3.sendMessage(msg.to,"Succes Clear Blacklist".format(str(len(wait["blacklist"])))) 
                              k4.sendMessage(msg.to,"Succes Clear Blacklist".format(str(len(wait["blacklist"])))) 
                              k5.sendMessage(msg.to,"Succes Clear Blacklist".format(str(len(wait["blacklist"])))) 
                              k6.sendMessage(msg.to,"Succes Clear Blacklist".format(str(len(wait["blacklist"])))) 
                              k7.sendMessage(msg.to,"Succes Clear Blacklist".format(str(len(wait["blacklist"])))) 
                              k8.sendMessage(msg.to,"Succes Clear Blacklist".format(str(len(wait["blacklist"])))) 
                              k9.sendMessage(msg.to,"Succes Clear Blacklist".format(str(len(wait["blacklist"])))) 
                              k9.sendMessage(msg.to,"Succes Clear Blacklist".format(str(len(wait["blacklist"])))) 
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                               try:
                                   ...
                                   cl.sendMessage(msg.to,"Chat has been cleared 👍")                                  
                               except:
                                   pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                               cl.sendMessage(msg.to, "🔴 Sname \n\n" + str(Setmain["keyCommand"]) + "􀰂􀰂✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η࿐❥")
...
#================BOT UPDATE NAME============#
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                cl.updateProfile(profile)
                                cl.sendMessage(msg.to,"nαmє chαngєd tσ " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                k1.sendMessage(msg.to,"nαmє chαngєd tσ " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                k2.sendMessage(msg.to,"nαmє chαngєd tσ " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                k3.sendMessage(msg.to,"nαmє chαngєd tσ " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                k4.sendMessage(msg.to,"nαmє chαngєd tσ " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                k5.sendMessage(msg.to,"nαmє chαngєd tσ " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                k6.sendMessage(msg.to,"nαmє chαngєd tσ " + string + "") 
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                k7.sendMessage(msg.to,"nαmє chαngєd tσ " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                k8.sendMessage(msg.to,"nαmє chαngєd tσ " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                k9.sendMessage(msg.to,"nαmє chαngєd tσ " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                k10.sendMessage(msg.to,"nαmє chαngєd tσ " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                g1.sendMessage(msg.to,"nαmє chαngєd tσ " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                g2.sendMessage(msg.to,"nαmє chαngєd tσ " + string + "")                    
#===========BOT UPDATE============#
                        ...
                        elif cmd == "masuk" or text.lower() == 'Join':
                         if msg._from in admin:
                           if msg.toType == 2:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               k1.sendMessage(msg.to, "􀰂􀰂✯ͥ ͣ ͫ͢Sԋαԋ•Zαιɳ࿐❥")
                               k2.sendMessage(msg.to, "􀰂􀰂✯ͥ ͣ ͫ͢Sԋαԋ•Zαιɳ࿐❥")
                               k3.sendMessage(msg.to, "􀰂􀰂✯ͥ ͣ ͫ͢Sԋαԋ•Zαιɳ࿐❥")
                               k4.sendMessage(msg.to, "􀰂􀰂✯ͥ ͣ ͫ͢Sԋαԋ•Zαιɳ࿐❥")
                               k5.sendMessage(msg.to, "􀰂􀰂✯ͥ ͣ ͫ͢Sԋαԋ•Zαιɳ࿐❥")
                               k6.sendMessage(msg.to, "􀰂􀰂✯ͥ ͣ ͫ͢Sԋαԋ•Zαιɳ࿐❥")
                               k7.sendMessage(msg.to, "􀰂􀰂✯ͥ ͣ ͫ͢Sԋαԋ•Zαιɳ࿐❥")
                               k8.sendMessage(msg.to, "􀰂􀰂✯ͥ ͣ ͫ͢Sԋαԋ•Zαιɳ࿐❥")
                               k9.sendMessage(msg.to, "􀰂􀰂✯ͥ ͣ ͫ͢Sԋαԋ•Zαιɳ࿐❥")
                               k10.sendMessage(msg.to, "􀰂􀰂✯ͥ ͣ ͫ͢Sԋαԋ•Zαιɳ࿐❥")
                                                       
                        elif cmd == "bye1":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                k1.sendMessage(msg.to, "Gσ ԋσɱҽ ϝιɾʂƚ "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                k2.sendMessage(msg.to, "Gσ ԋσɱҽ ϝιɾʂƚ "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                k3.sendMessage(msg.to, "Gσ ԋσɱҽ ϝιɾʂƚ "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                k4.sendMessage(msg.to, "Gσ ԋσɱҽ ϝιɾʂƚ "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                k5.sendMessage(msg.to, "Gσ ԋσɱҽ ϝιɾʂƚ "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                k6.sendMessage(msg.to, "Gσ ԋσɱҽ ϝιɾʂƚ "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                k7.sendMessage(msg.to, "Gσ ԋσɱҽ ϝιɾʂƚ "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                k8.sendMessage(msg.to, "Gσ ԋσɱҽ ϝιɾʂƚ "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                k9.sendMessage(msg.to, "Gσ ԋσɱҽ ϝιɾʂƚ "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                k10.sendMessage(msg.to, "Gσ ԋσɱҽ ϝιɾʂƚ "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                                G = cl.getGroup(msg.to)
                                cl.sendMessage(msg.to, "Thanks for invitations, /nfind another time ..."+str(G.name))
                                cl.leaveGroup(msg.to)
                                
                        elif cmd == "pulang" or text.lower() == 'Byeall':
                           if wait["selfbot"] == True:
                            if msg._from in admin:
                               k1.leaveGroup(msg.to)
                               k2.leaveGroup(msg.to)
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                G = cl.getGroup(group)
                                try:
                                    k1.sendMessage(group,"sorry first but first and see you later, please invite our owner")
                                    k1.leaveGroup(group)
                                    k2.leaveGroup(group)
                                    k3.leaveGroup(group)
                                    k4.leaveGroup(group)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ...
                                    k1.inviteIntoGroup(msg.to, [g1MID])
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ginfo = k1.getGroup(msg.to)
                                    k1.inviteIntoGroup(msg.to, [g2MID])
                                    ginfo = cl.getGroup(msg.to)
...
#====================================================================                            
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 cl.sendMessage(msg.to, "Lurking Enabled\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 cl.sendMessage(msg.to, "Lurking Disabled\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if msg._from in admin:
                            if msg.to in Setmain['SKreadPoint']:
                                if Setmain['SKreadMember'][msg.to] != {}:
                                    ...
                                    cl.sendMessage(msg.to, "User Blank...")
                            else:
                                cl.sendMessage(msg.to, "Type lurking on Past")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in owner or msg._from in admin or msg._from in staff:
                              try:
                                  tz = pytz.timezone("Asia/Jakarta")
                                  timeNow = datetime.now(tz=tz)
                                  cl.sendMessage(msg.to, "Cek sider αcтιvαтed\n\nDate "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nTime  "+ datetime.strftime(timeNow,'%H:%M:%S')+" ")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in owner or msg._from in admin or msg._from in staff:
                              if msg.to in cctv['point']:
                                  ...
                                  cl.sendMessage(msg.to, "Cek sider deαcтιvαтed\n\nDate "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nTime  "+ datetime.strftime(timeNow,'%H:%M:%S')+" ")
                              else:
...
#==============add video==========================================================================
                          ...
                          if msg._from in admin:
                            ...
                            if name in images:
                                ...
                                f = codecs.open("image.json","w","utf-8")
                                json.dump(images, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendMessage(msg.to, "Successfully deleted {}".format( str(name.lower())))
                            else:
...
#=========== [ Add Video ] ============#                               
                          ...
                          if msg._from in admin:
                            ...
                            if name in videos:
                                ...
                                f = codecs.open("video.json","w","utf-8")
                                json.dump(videos, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendMessage(msg.to, "Successfully deleted video {}".format( str(name.lower())))
                            else:
                           ...
                           if msg._from in admin:
                             ...
                             cl.sendMessage(to, ret_)
                             sendMention(msg.to, msg._from,"","\nJika ingin play video nya,\nSilahkan Type nama - judul\nBisa juga Type namanya saja")
#=========== [ Add Video ] ============#                               
                          ...
                          if msg._from in admin:
                            ...
                            if name in audios:
                                ...
                                f = codecs.open("audio.json","w","utf-8")
                                json.dump(audios, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendMessage(msg.to, "Successfully deleted mp3 {}".format( str(name.lower())))
                            else:
...
#=========== [ Add Sticker ] ============#                                            
                          ...
                          if msg._from in admin:
                            ...
                            if name in stickers:
                                ...
                                f = codecs.open("sticker.json","w","utf-8")
                                json.dump(stickers, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendMessage(msg.to, "Successfully deleted sticker {}".format( str(name.lower())))
                            else:
...
#====================================================================                                                       
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                                ...
                                num =  int(strnum)
                                wait["limit"] = num
                                cl.sendMessage(msg.to,"Total Spamcall Changed into " +strnum)
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in owner:
                             if msg.toType == 2:
                                ...
                                jmlh = int(wait["limit"])
                                cl.sendMessage(msg.to, "Successfully invited {} Call Group invitation".format(str(wait["limit"])))
                                if jmlh <= 1000:
                                  for x in range(jmlh):
                                     try:
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in welcome:
                                       ...
                                       ginfo = cl.getGroup(msg.to)
                                       msgs = "Welcome Msg αcтιvαтed\nDi Group : " +str(ginfo.name)
                                  cl.sendMessage(msg.to, "「αcтιvαтed」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in welcome:
                                         welcome.remove(msg.to)
                                         ginfo = cl.getGroup(msg.to)
                                         msgs = "Welcome Msg deαcтιvαтed\nDi Group : " +str(ginfo.name)
                                    else:
                                         msgs = "Welcome Msg already inactive"
                                    cl.sendMessage(msg.to, "「deαcтιvαтed」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Url 」\n" + msgs)
                                    ...
                                    if msg.to in protectqr:
                                         ...
                                         msgs = "Protect url already inactive"
                                    cl.sendMessage(msg.to, "「 Status Protect Url 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect kick 」\n" + msgs)
                                    ...
                                    if msg.to in protectkick:
                                         ...
                                         msgs = "Protect kick already inactive"
                                    cl.sendMessage(msg.to, "「 Status Protect kick 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Join 」\n" + msgs)
                                    ...
                                    if msg.to in protectjoin:
                                         ...
                                         msgs = "Protect join already inactive"
                                    cl.sendMessage(msg.to, "「 Status Protect Join 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Cancel 」\n" + msgs)
                                    ...
                                    if msg.to in protectcancel:
                                         ...
                                         msgs = "Protect cancel already inactive"
                                    cl.sendMessage(msg.to, "「 Status Protect Cancel 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Invite 」\n" + msgs)
                                    ...
                                    if msg.to in protectinvite:
                                         ...
                                         msgs = "Protect invite already inactive"
                                    cl.sendMessage(msg.to, "「 Status Protect Invite 」\n" + msgs)
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protectantijs:
                                       msgs = "Protect Antikicker activated"
                                  else:
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Anti Kicker 」\n" + msgs)
                                    ...
                                    if msg.to in protectantijs:
                                         ...
                                         msgs = "Protect Anti Kicker already inactive"
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  ...
                                  if msg.to in protectcancel:
                                      ginfo = cl.getGroup(msg.to)
                                      msgs = "Status : [ ✔ ]\nDi Group : " +str(ginfo.name)
                                      msgs += "\nAll protecttion Are αcтιvαтed"
                                  else:
                                      protectcancel.append(msg.to)
                                      ginfo = cl.getGroup(msg.to)
                                      msgs = "Status : [ ✔ ]\nDi Group : " +str(ginfo.name)
                                      msgs += "\nAll protection αcтιvαтed"
                                  cl.sendMessage(msg.to, "「 Status Protection 」\n" + msgs)
                                    ...
                                    if msg.to in protectcancel:
                                         ...
                                         ginfo = cl.getGroup(msg.to)
                                         msgs = "Status : [ ❌ ]\nDi Group : " +str(ginfo.name)
                                         msgs += "\nAll protection are Off"
                                    else:
                                         ginfo = cl.getGroup(msg.to)
                                         msgs = "Status : [ ❌ ]\nDi Group : " +str(ginfo.name)
                                         msgs += "\nAll protection is turned off"
                                    cl.sendMessage(msg.to, "「 Status Protection 」\n" + msgs)       
#===========KICKOUT============#       
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                             if msg.toType == 2:
                                 ...
                                 cl.sendMessage(msg.to,"「 ɪ ᴅᴏɴᴛ ᴋɴᴏᴡ, 😚😚😚」")
                                 cl.sendMessage(msg.to,"「ωнαт ωιℓℓ нαρρєи иσω」")
                                 targets = []
                                 for g in gs.members:
                           ...
                           if msg._from in owner or msg._from in admin or msg._from in staff:
                           	if msg.toType == 2:
                                  ginfo = cl.getGroup(msg.to)
                                  cl.sendMessage(msg.to, "Process Cleanse....")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               cl.sendMessage(msg.to, "I’m an odd combination of “Really Sweet” and “Don’t mess with me")
                               cl.sendContact(to, mid)
                               cl.sendContact(to, Amid)
                               cl.sendContact(to, Bmid)
                               cl.sendContact(to, Amid)
                            ...
                            if msg._from in owner or msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Team:
                                       try:
                                           staff.append(target)
                                           cl.sendMessage(msg.to,"succєssfullч Promoted sᴛᴀғғ")
                                       except:
                                           pass
                            ...
                            if msg._from in owner or msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Team:
                                       try:
                                           Bots.append(target)
                                           cl.sendMessage(msg.to,"succєssfullч Promoted ʙᴏᴛ")
                                       except:
                                           pass
                            ...
                            if msg._from in owner or msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Team:
                                       try:
                                           admin.append(target)
                                           cl.sendMessage(msg.to,"succєssfullч Promoted admin")
                                       except:
                                           pass
                            ...
                            if msg._from in owner or msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Team:
                                       try:
                                           staff.remove(target)
                                           cl.sendMessage(msg.to,"succєssfullч Removed from sᴛᴀғғ")
                                       except:
                                           pass
                            ...
                            if msg._from in owner:
                               ...
                               for target in targets:
                                   if target not in Team:
                                       try:
                                           Bots.remove(target)
                                           cl.sendMessage(msg.to,"succєssfullч Removed from ʙᴏᴛs")
                                       except:
                                           pass
#====================================#                                         
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                                ...
                                cl.sendMessage(msg.to,"Notag αcтιvαтed")

                        elif cmd == "notag off" or text.lower() == 'notag off':
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                                wait["MentionKick"] = False
                                cl.sendMessage(msg.to,"Notag deαcтιvαтed")

                        elif cmd == "contact on" or text.lower() == 'contact on':
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                                wait["contact"] = True
                                cl.sendMessage(msg.to,"Deteksi contact αcтιvαтed")

                        elif cmd == "contact off" or text.lower() == 'contact off':
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                                wait["contact"] = False
                                cl.sendMessage(msg.to,"Deteksi contact deαcтιvαтed")

                        elif cmd == "respon on" or text.lower() == 'respon on':
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                                wait["detectMention"] = True
                                cl.sendMessage(msg.to,"Auto respon αcтιvαтed")

                        elif cmd == "respon off" or text.lower() == 'respon off':
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                                wait["detectMention"] = False
                                cl.sendMessage(msg.to,"Auto respon deαcтιvαтed")

                        elif cmd == "autojoin on" or text.lower() == 'autojoin on':
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                                wait["autoJoin"] = True
                                cl.sendMessage(msg.to,"Autojoin αcтιvαтed")

                        elif cmd == "autojoin off" or text.lower() == 'autojoin off':
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                                wait["autoJoin"] = False
                                cl.sendMessage(msg.to,"Autojoin deαcтιvαтed")

                        elif cmd == "autoleave on" or text.lower() == 'autoleave on':
                          if wait["selfbot"] == True:
                            if msg._from in admin or msg._from in owner:
                                wait["autoLeave"] = True
                                cl.sendMessage(msg.to,"Autoleave αcтιvαтed")

                        elif cmd == "autoleave off" or text.lower() == 'autoleave off':
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                                wait["autoLeave"] = False
                                cl.sendMessage(msg.to,"Autoleave deαcтιvαтed")

                        elif cmd == "autoadd on" or text.lower() == 'autoadd on':
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                                wait["autoAdd"] = True
                                cl.sendMessage(msg.to,"Auto add αcтιvαтed")

                        elif cmd == "autoadd off" or text.lower() == 'autoadd off':
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                                wait["autoAdd"] = False
                                cl.sendMessage(msg.to,"Auto add deαcтιvαтed")

                        elif cmd == "sticker on" or text.lower() == 'sticker on':
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                                wait["sticker"] = True
                                cl.sendMessage(msg.to,"Deteksi sticker αcтιvαтed")

                        elif cmd == "sticker off" or text.lower() == 'sticker off':
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                                wait["sticker"] = False
                                cl.sendMessage(msg.to,"Deteksi sticker deαcтιvαтed")

                        elif cmd == "jointicket on" or text.lower() == 'jointicket on':
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                                settings["autoJoinTicket"] = True
                                cl.sendMessage(msg.to,"Auto Join Ticket αcтιvαтed")

                        elif cmd == "jointicket off" or text.lower() == 'jointicket off':
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                                settings["autoJoinTicket"] = False
                                cl.sendMessage(msg.to,"Auto join Ticket deαcтιvαтed")
                                
                        elif cmd == "unsend on" or text.lower() == 'unsend on':
                          if settings["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                                settings["unsendMessage"] = True
                                cl.sendMessage(msg.to,"detect unsend αcтιvαтed")

                        elif cmd == "unsend off" or text.lower() == 'unsend off':
                          if settings["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                                settings["unsendMessage"] = False
                                cl.sendMessage(msg.to,"detect unsend deαcтιvαтed")
...
#===========COMMAND BLACKLIST============#
                            ...
                            if msg.toType == 2:
                                ...
                                targets.remove(mid)
                                if targets == []:
                                    cl.sendMessage(msg.to,"there are no people")
                                else:
                                    for target in targets:
                                         if target not in wait["selfbot"] or target not in Bots:
                                            try:
                                                wait["blacklist"][target] = True
                                                cl.sendMessage(msg.to,"You are tarnished")
                                            except:
                                                pass
                            ...
                            if msg.toType == 2:
                                ...
                                targets.remove(mid)
                                if targets == []:
                                    cl.sendMessage(msg.to,"Limit my boss")
                                else:
                                    for target in targets:
                                            try:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in creator or msg._from in owner or msg._from in admin:
                              wait["blacklist"] = {}
                               ...
                               cl.sendMessage(msg.to, "Just Useless")
                          ...
                          if wait["selfbot"] == True:
                            if sender in admin:
                              ...
                              with open('bl.json', 'w') as fp:
                               ...
                               cl.sendMessage(msg.to, " My Owner: 􀰂􀰂✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η࿐❥")
#===========COMMAND SET============#
                           ...
                           if msg._from in admin:
                              ...
                              if spl in [""," ","\n",None]:
                                  cl.sendMessage(msg.to, "Failed to replace Message")
                              else:
                                  wait["message"] = spl
                                  cl.sendMessage(msg.to, "Changed".format(str(spl)))
                            ...
                            if msg._from in admin or msg._from in owner:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     cl.sendMessage(msg.to, "􀰂􀰂✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η࿐❥ Sɪʟᴇɴᴛᴷᶦˡˡᵉʳ ɢᴏ : %s" % str(group.name))
